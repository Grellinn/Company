	...
	public class CompanyInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<CompanyContext>
	{
		protected override void Seed(CompanyContext dbContext)
		{
			...
			var projects = new List<Project>
			{
				...
				new Project { Title="Gera við og sprauta bílskúrsþak", ClientID=1, Details ="Þvo, gera við og sprauta bílskúrsþak með dökk gráu", StartedDate=DateTime.Parse("2014/07/06"), OfferPrice=0, TotalIncome=0, TotalExpense=0, Address="Hátún 6B", ZipCode="105 RVK", Status="Verkefni hafið", RegisteredDate=DateTime.Now },
			...
			{
				new Income { Description="Fyrsti hluti fyrir framkvæmdum á húsi", ProjectID=3, Registered=DateTime.Now, Title="Innborgun frá Hátúni 6B", Amount=200000 },
				new Income { Description="Annar hluti fyrir framkvæmdum á húsi", ProjectID=3, Registered=DateTime.Now, Title="Innborgun frá Hátúni 6B", Amount=200000 },
				new Income { Description="Þriðji hluti fyrir framkvæmdum á húsi", ProjectID=3, Registered=DateTime.Now, Title="Innborgun frá Hátúni 6B", Amount=200000 },
				new Income { Description="Fyrsti hluti fyrir framkvæmdum á bílskúr", ProjectID=3, Registered=DateTime.Now, Title="Innborgun frá Hátúni 6B", Amount=200000 },
				new Income { Description="Annar hluti fyrir framkvæmdum á bílskúr", ProjectID=3, Registered=DateTime.Now, Title="Innborgun frá Hátúni 6B", Amount=200000 },
				new Income { Description="Þriðji hluti fyrir framkvæmdum á bílskúr", ProjectID=3, Registered=DateTime.Now, Title="Innborgun frá Hátúni 6B", Amount=200000 }
			};
			...
			{
				new Expense { Title="Málning ehf.", Amount=40000, Description="Málara hvítt Steintex á stein 100L", ProjectID=3, Registered=DateTime.Now },
				new Expense { Title="Málning ehf.", Amount=40000, Description="Toskana grár Kjörvari á tré 20L", ProjectID=3, Registered=DateTime.Now },
				new Expense { Title="Málning ehf.", Amount=40000, Description="Dökk grá þakmálning 40L", ProjectID=3, Registered=DateTime.Now },
				new Expense { Title="Launakostnaður", Amount=40000, Description="40 vinnustundir, Grétar, Davíð og Davíð", ProjectID=3, Registered=DateTime.Now },
				new Expense { Title="Launakostnaður", Amount=40000, Description="40 vinnustundir, Grétar, Davíð og Davíð", ProjectID=3, Registered=DateTime.Now },
				new Expense { Title="Launakostnaður", Amount=40000, Description="30 vinnustundir, Grétar, Davíð og Davíð", ProjectID=3, Registered=DateTime.Now }
			};
